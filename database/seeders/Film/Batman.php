    ...
    public function run(): void
    {
        $films = [
            [
                ...
                'url' => '',
                'cover_url' => 'https://f005.backblazeb2.com/file/nochedepelis/portadas/Batman+Begins.webp'
            ],
            [
                'id' => (string) Str::uuid(),
                'user_id' => 1,
                ...
                'url' => '',
                'cover_url' => 'https://f005.backblazeb2.com/file/nochedepelis/portadas/Batman-+El+Caballero+Oscuro.webp'
            ],
            [
                'id' => (string) Str::uuid(),
                'user_id' => 1,
                ...
                'url' => '',
                'cover_url' => 'https://f005.backblazeb2.com/file/nochedepelis/portadas/Batman-+La+Leyenda+Renace.webp'
            ],
            [
                'id' => (string) Str::uuid(),
                'user_id' => 1,

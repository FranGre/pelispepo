    ...
    public function run(): void
    {
        $films = [
            [
                ...
                'url' => 'https://f005.backblazeb2.com/file/nochedepelis/pelis/LAT/Deadpool_1_(2016).mp4',
                'cover_url' => 'https://f005.backblazeb2.com/file/nochedepelis/portadas/Deadpool.webp'
            ],
            [
                'id' => (string) Str::uuid(),
                'user_id' => 1,
                ...
                'url' => 'https://f005.backblazeb2.com/file/nochedepelis/pelis/LAT/Deadpool_2(2018).mp4',
                'cover_url' => 'https://f005.backblazeb2.com/file/nochedepelis/portadas/Deadpool+2.webp'
            ],
            [
                'id' => (string) Str::uuid(),
                'user_id' => 1,
                ...
                'url' => 'https://f005.backblazeb2.com/file/nochedepelis/pelis/LAT/Deadpool_y_Lobezno.mp4',
                'cover_url' => 'https://f005.backblazeb2.com/file/nochedepelis/portadas/Deadpool_y_Lobezno.webp'
            ]
        ];

    ...
    public function run(): void
    {
        $films = [
            ...
            [
                ...
                'url' => '',
                'cover_url' => 'https://f005.backblazeb2.com/file/nochedepelis/portadas/Iron+Man+2.webp'
            ],
            [
                'id' => (string) Str::uuid(),
                'user_id' => 1,
                ...
                'url' => '',
                'cover_url' => 'https://f005.backblazeb2.com/file/nochedepelis/portadas/Iron+Man+3.webp'
            ]
        ];

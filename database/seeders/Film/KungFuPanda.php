    ...
    public function run(): void
    {
        $films = [
            [
                ...
                'url' => '',
                'cover_url' => 'https://f005.backblazeb2.com/file/nochedepelis/portadas/Kung+Fu+Panda.webp'
            ],
            [
                'id' => (string) Str::uuid(),
                'user_id' => 1,
            ...
            [
                ...
                'url' => '',
                'cover_url' => 'https://f005.backblazeb2.com/file/nochedepelis/portadas/Kung+Fu+Panda+4.webp'
            ]
        ];

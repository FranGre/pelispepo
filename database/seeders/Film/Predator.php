    ...
    public function run(): void
    {
        $films = [
            ...
            [
                ...
                'url' => '',
                'cover_url' => 'https://f005.backblazeb2.com/file/nochedepelis/portadas/Alien+vs.+Predator.webp'
            ],
            [
                'id' => (string) Str::uuid(),
                'user_id' => 1,
                ...
                'url' => '',
                'cover_url' => 'https://f005.backblazeb2.com/file/nochedepelis/portadas/Aliens+vs.+Predator+2.webp'
            ],
            [
                'id' => (string) Str::uuid(),
                'user_id' => 1,
            ...
            [
                ...
                'url' => '',
                'cover_url' => 'https://f005.backblazeb2.com/file/nochedepelis/portadas/Predator+2018.webp'
            ],
            [
                'id' => (string) Str::uuid(),
                'user_id' => 1,
                ...
                'url' => '',
                'cover_url' => 'https://f005.backblazeb2.com/file/nochedepelis/portadas/Predator-La+presa.webp'
            ]
        ];

    ...
    <AuthenticatedLayout>
        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-3 md:gap-6 place-items-center">
            <div @click="goToViewFilms()"
                class="card bg-base-100 hover:bg-base-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 md:max-w-72 lg:max-w-96 w-full shadow-sm hover:cursor-pointer">
                <div class="card-body">
                    <div class="flex justify-between">
                        ...
                        <div class="card-title">{{ filmsCounter }}</div>
                    </div>
                </div>
            </div>
            <div @click="goToViewGenders()"
                ...
                <div class="card-body">
                    <div class="flex justify-between">
                        ...
                        <div class="card-title">{{ gendersCounter }}</div>
                    </div>
                </div>
            </div>
            <div @click="goToViewUsers()"
                ...
                <div class="card-body">
                    <div class="flex justify-between">
                        ...
                        <div class="card-title">{{ usersCounter }}</div>
                    </div>
                </div>
            </div>
        </div>
...
defineProps({
    filmsCounter: Number,
    gendersCounter: Number,
    usersCounter: Number
})

function goToViewFilms() {
    router.visit(route('admin.films.index'))
}

function goToViewGenders() {

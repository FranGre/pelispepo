    ...
    <AuthenticatedLayout>
        ...
        <div class="flex justify-around">
            <div class="flex gap-1 items-center">
                <p>{{ props.likesCounter }}</p>
                <button type="button" @click="handleLike(props.film.id)">
                    <svg v-if="!hasLike" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    ...
                    <svg v-else xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        fill="currentColor" class="icon icon-tabler icons-tabler-filled icon-tabler-thumb-up">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        <path
            ...
            <div>
                <button type="button" @click="handleFavorite(props.film.id)">
